   ...
   return (
        <div className="container about">
            <div className="row">
                ...
                <img width="350px"  src="https://i.ibb.co/x3wCs6P/best-travel-agency-in-chandigarh-1.jpg" alt="" />
                </div>
                <div className="col-lg-6 col-sm-12">
            ...
            <div className="row">
                ...
                <div className="col-lg-6 col-sm-12">
                <img width="350px" src="https://i.ibb.co/RQZs1f5/World-Map-Travel-Full-HD-1.jpg" alt="" />
                </div>
            </div>
            ...
            <div className="bottom-content mt-5">
                ...
                <h1 className="fw-bold">Recent Awards </h1>
                <p>2021 Great Place to Work
